...
// ---------------------------------------------------------------------------
// Device: in-place radix-2 FFT (forward or inverse).  This duplicates the
// existing gbfd_radix2_fft_inplace logic so the Bluestein helpers can stay
// self-contained, but with an `inverse` flag.
// ---------------------------------------------------------------------------
CUDA_DEVICE
