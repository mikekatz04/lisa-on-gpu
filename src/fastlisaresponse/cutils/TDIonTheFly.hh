...
// gb_tdi_on_the_fly.hh (Phase 3L.7c + 3L.7f.1, 2026-06-04).
// SOBBHTDIonTheFly + SOBBHComputationGroup aliasing moved to BBHx's
// sobbh_tdi_on_the_fly.hh (Phase 3L.8, 2026-06-04). Both classes are
// included transitively via the downstream consumers (binding_gbgpu.hpp,
// binding_bbhx.hpp); this header no longer needs to alias them.
// FDSplineTDIWaveform + TDSplineTDIWaveform aliases moved to LAT at
// Phase 3L.6. WaveletLookupTable disabled at Phase 3L (2026-06-02) --
// lookup-table spline path is being retired.
...
// SOBBHTDIonTheFly class declaration + sobbh_run_wave_tdi_wrap decl moved to BBHx
// at Phase 3L.8 (2026-06-04). See BBHx/src/bbhx/cutils/sobbh_tdi_on_the_fly.hh.
...
// SOBBHComputationGroup class declaration moved to BBHx at Phase 3L.8 (2026-06-04).
// See BBHx/src/bbhx/cutils/sobbh_tdi_on_the_fly.hh.
