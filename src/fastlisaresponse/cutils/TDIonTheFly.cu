...
// Active templated wdm_het_*_kernel bodies moved to LAT at Phase 3L.7a
// slice 3 (2026-06-04); see lisatools/cutils/lat_chunked_het_kernels.hh
// included near the top of this file. The four moved kernels:
...
// All four are CUDA_KERNEL templates instantiated below at
// gb_wdm_het_*_wrap / sobbh_wdm_het_*_wrap (still in this file) against
// <GBTDIonTheFly> / <SOBBHTDIonTheFly>. Phase 3L.7 / 3L.8 will move
// those instantiations to GBGPU / BBHx alongside their *ComputationGroup
// wrap methods.
...
// Phase 3L.8 (2026-06-04): SOBBHTDIonTheFly PN intrinsic-quantity helpers +
// method bodies + sobbh_run_wave_tdi kernel/wrap moved to BBHx.
// See BBHx/src/bbhx/cutils/sobbh_tdi_on_the_fly.{hh,cu}.
...
// Active templated wdm_het_*_impl<SourceT> launchers moved to LAT at
// Phase 3L.7a slice 3 (2026-06-04); see
// lisatools/cutils/lat_chunked_het_kernels.hh included near the top
// of this file. The four moved launchers (`wdm_het_fill_global_impl`,
// `wdm_het_get_ll_impl`, `wdm_het_swap_ll_impl`,
// `wdm_het_get_fstat_ll_impl`) are `inline template<class SourceT>`
// (was `static template` in this file -- converted to inline so the
// header can be included in multiple TUs without ODR collisions).
// The GBComputationGroup::gb_wdm_het_*_wrap + SOBBHComputationGroup::
// sobbh_wdm_het_*_wrap methods below instantiate them against
// <GBTDIonTheFly> / <SOBBHTDIonTheFly>; those instantiations move to
// GBGPU / BBHx at Phase 3L.7 / 3L.8.



// Phase 3L.8 (2026-06-04): SOBBHComputationGroup::sobbh_wdm_het_*_wrap
// method bodies moved to BBHx. See
// BBHx/src/bbhx/cutils/sobbh_tdi_on_the_fly.cu.
